...
class FlutterPage extends StatelessWidget {
                  ...
                  Center(
                    child: Container(
                      decoration: BoxDecoration(
                        ...
                        boxShadow: [
                          BoxShadow(
                            color: secondaryBrand.withValues(alpha:0.3),
                            blurRadius: 40,
                            spreadRadius: 10,
                          )
                        ],
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          _buildStatItem(Icons.auto_awesome_rounded, "Live", "Mentorship", Colors.orange),
                        ],
                      ),
                      ...
                      const Text(
                        ...
                        style: TextStyle(fontSize: 16, height: 1.6, color: Color(0xFF64748B)),
                      ),
                      const SizedBox(height: 40),
                      ...
                      _buildEnhancedTimeline([
                        ...
                        _TimelineData("03", "Backend & APIs", "REST APIs, JSON, Database", true),
                        _TimelineData("04", "Production Ready", "Optimization & Deployment", false),
                      ], primaryBrand),
          ...
          children: [
            Column(
              children: [
                ...
                if (item.showLine)
                  Container(width: 2, height: 60, decoration: BoxDecoration(color: color.withValues(alpha:0.1), borderRadius: BorderRadius.circular(2))),
              ],
            ),
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Text(item.subtitle, style: const TextStyle(color: Color(0xFF64748B), fontSize: 14)),
        ...
        children: [
          ...
          const Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text("Capstone Project", style: TextStyle(color: Colors.white, fontSize: 18, fontWeight: FontWeight.bold)),
                SizedBox(height: 4),
                Text("Build a Production-Ready App", style: TextStyle(color: Colors.white70, fontSize: 14)),
              ],
            ),
          ),
        ],
  ...
  Widget _buildCertificateCard(Color color) {
    return Container(
      ...
      child: Column(
        children: [
          Icon(Icons.verified_user_rounded, color: color, size: 32),
          const SizedBox(height: 12),
          const Text("Industry-Recognized Certificate", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
        ],
      ),
    );
  }
