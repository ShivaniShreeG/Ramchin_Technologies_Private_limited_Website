...
class _HospitalManagementPageState extends State<HospitalManagementPage>
            ...
            child: Column(
              children: [
                      ...
                      children: [
                        ElevatedButton(
                          style: ElevatedButton.styleFrom(
                            backgroundColor: Color(0xFFBF955E),
                        ...
                        OutlinedButton(
                          style: OutlinedButton.styleFrom(
                            side: BorderSide(color: Color(0xFFBF955E), width: 2),
                            padding: const EdgeInsets.symmetric(horizontal: 32, vertical: 18),
                            shape: RoundedRectangleBorder(
                              borderRadius: BorderRadius.circular(40),
                            ),
                            ...
                            overlayColor: WidgetStateProperty.all(Colors.yellow.shade50),
                          ),
                ...
                Container(
                  ...
                  child: Center(
                    child: ConstrainedBox(
                      ...
                      child: Column(
                        children: [
                          _sectionTitle("Explore Our Hospital System Live"),
                          ...
                          SizedBox(
                            width: 650,
                            child: Text(
                              "Login with demo accounts and experience Patient Management, Appointments, Billing, Reports and Real-Time Communication.",
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              color:  Colors.yellow.shade50.withValues(alpha: 0.2),
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: Colors.yellow.shade50.withValues(alpha: 0.2).withValues(alpha: 0.9),
                  ...
                  child: Column(
                    children: [
                      _sectionTitle("Why Hospitals Choose Us?"),
                      const SizedBox(height: 50),
                      _featuresGrid(),
                    ],
                  ),
                ...
                Footer(
                  ...
                  onPressed: () =>
                      _launch("https://hospitalmanagement.ramchintech.com"),
                  backgroundColor: Color(0xFFBF955E),
                  cornercolor:Colors.yellow.shade50.withValues(alpha: 0.2).withValues(alpha: 0.9),
                ),
              ],
            ),
          ),
            ...
            Positioned(
              ...
              child: AnimatedOpacity(
                ...
                child: FloatingActionButton(
                  ...
                  child: const Icon(Icons.keyboard_arrow_up, size: 28, color:Color(0xFFBF955E),),
                ),
              ),
            ),
        ],
      ...
      child: Material(
        ...
        child: InkWell(
          ...
          child: Container(
            ...
            child: const Icon(Icons.arrow_back_ios_new, color:Color(0xFFBF955E), size: 20),
          ),
        ),
      ),
    );
  ...
  Widget _featuresGrid() {
    final features = [
      {
        "title": "Easy To Use",
        "desc": "Simple interface for doctors, nurses and hospital staff.",
        "icon": Icons.local_hospital,
      },
      {
        "title": "Save 70% Admin Time",
        "desc": "Automate appointments, billing and patient records.",
        "icon": Icons.timer,
      },
      {
      ...
      },
      {
        ...
        "desc": "Accurate patient history & treatment insights.",
        "icon": Icons.medical_information,
      },
      {
        "title": "Secure Cloud System",
        "desc": "Your hospital data is safe and encrypted.",
        "icon": Icons.security,
      },
      {
        "title": "All-in-One Platform",
        "desc": "Everything your hospital needs in one system.",
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    height: 64,
                    decoration: BoxDecoration(
                      color: Colors.yellow.shade50.withValues(alpha: 0.07),
  ...
  Widget _downloadCard() {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color: Color(0xFFBF955E).withValues(alpha: 0.2),
            blurRadius: 30,
          ...
          Wrap(
            ...
            children: [
              ...
              StoreButton(
                ...
                label: "Website",
                onTap: () => _launch(
                  "https://hospitalmanagement.ramchintech.com",
                ),
              ),
            ],
          ),
...
class DemoCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: Colors.white,
        borderRadius: BorderRadius.circular(24),
        border: Border.all(color:Color(0xFFBF955E).withValues(alpha: 0.2)),
        boxShadow: [
          BoxShadow(
            color: Colors.black.withValues(alpha: 0.04),
            blurRadius: 25,
        ...
        children: [
          Center(
            child:Container(
              ...
              decoration: BoxDecoration(
               color:Color(0xFFBF955E).withValues(alpha: 0.02),
          ...
          _infoTile("Hospital ID", hospitalid),
  ...
  Widget _infoTile(String label, String value) {
    return Container(
      ...
      decoration: BoxDecoration(
        color:Color(0xFFBF955E).withValues(alpha: 0.07),
