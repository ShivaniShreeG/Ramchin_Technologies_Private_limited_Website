  ...
  final List<Map<String, dynamic>> features = const [
    {
      ...
      "description": "Record and categorize your daily expenses easily.",
      "icon": Icons.account_balance_wallet,
    },
    {
      "title": "Income Management",
      "description": "Track multiple income sources and recurring payments.",
      "icon": Icons.attach_money,
    },
    {
      "title": "Budget Planner",
      "description": "Set budgets for categories and stay on top of your spending.",
      "icon": Icons.pie_chart,
    },
    {
      "title": "Reports & Analytics",
      "description": "Visualize your finances through charts and summaries.",
      "icon": Icons.bar_chart_rounded,
    },
    {
      "title": "Reminders & Notes",
      "description": "Add notes or reminders for bills, subscriptions, or goals.",
      "icon": Icons.note_alt_rounded,
    },
    {
      "title": "Secure Access",
      "description": "Protect your data with passcodes & cloud backup.",
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        const Text(
                          "Track your finances, plan your budget, and gain control over your money",
                          textAlign: TextAlign.center,
                          style: TextStyle(
                            fontSize: 15,
