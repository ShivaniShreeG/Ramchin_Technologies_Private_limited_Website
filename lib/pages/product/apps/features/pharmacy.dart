...
class _FeaturesPageState extends State<FeaturesPage> {
  static const Map<String, List<Map<String, dynamic>>> roleFeatureOverview = {
    "Admin": [
      {
        "title": "Smart Pharmacy Dashboard",
        "description": "Real-time view of inventory, sales, prescriptions, and revenue in one central dashboard.",
        "icon": Icons.dashboard_customize_rounded,
      },
      {
        "title": "Inventory & Supplier Management",
        "description": "Track medicine stock, suppliers, and expiry dates efficiently.",
        "icon": Icons.inventory_2_rounded,
      },
      {
        "title": "Billing & Invoicing",
        "description": "Generate bills, process payments, and issue receipts quickly and securely.",
        "icon": Icons.payment_rounded,
      },
      {
        "title": "Analytics & Reports",
        "description": "Monitor sales trends, stock alerts, and pharmacy performance with actionable reports.",
        "icon": Icons.bar_chart_rounded,
      },
      {
        "title": "Secure & Compliant",
        "description": "Maintain compliance with medical and data regulations.",
        "icon": Icons.security_rounded,
      },
      {
        "title": "24/7 Support",
        "description": "Access dedicated technical support whenever you need.",
    ...
    "Staff": [
      {
        ...
        "description": "Process and manage prescriptions efficiently with automatic alerts for errors.",
        "icon": Icons.receipt_long_rounded,
      },
      {
        "title": "Stock & Alerts",
        "description": "Monitor stock levels, low inventory, and expiry notifications.",
        "icon": Icons.inventory_2_rounded,
      },
      {
        "title": "Billing & Checkout",
        "description": "Handle billing, payment processing, and receipt generation for customers.",
        "icon": Icons.point_of_sale_rounded,
      },
      {
        "title": "Customer Interaction",
        "description": "Manage customer profiles, queries, and order history seamlessly.",
        "icon": Icons.person_rounded,
      },
      {
        "title": "Reporting & Logs",
        "description": "Access daily reports and transaction logs for transparency and accountability.",
        "icon": Icons.receipt_long_rounded,
      },
      {
        "title": "Internal Communication",
        "description": "Stay connected with Admin for approvals, updates, and stock requests.",
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        const Text(
                          "Empowering Pharmacy Through Smart Digital Solutions",
                          textAlign: TextAlign.center,
                          style: TextStyle(
                            fontSize: 15,
