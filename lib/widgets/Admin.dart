    ...
    return Container(
      decoration: const BoxDecoration(
        gradient: LinearGradient(
          colors: [Color(0xFF60C5FF), Color(0xFFFFFFFF)],
      ...
      child: SingleChildScrollView(
        ...
        padding: const EdgeInsets.symmetric(horizontal: 148, vertical: 148),
        child: Center(
          child: ClipRRect(
                ...
                child: Form(
                  ...
                  child: Column(
                    ...
                    children: [
                      Column(
                        children: [
                          Image.asset('ic_launcher.png',height: 110),
                        ],
                      ),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Container(
        child: Center(
          child: SingleChildScrollView(
            // Ensures the box stays centered but scrolls if content > height
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(
                              ...
                              child: ElevatedButton(
                                onPressed:
                                _isLoading ? null : () => _adminRegister(),
                                style: ElevatedButton.styleFrom(
