...
class LodgeManagementPage extends StatefulWidget {
  const LodgeManagementPage({super.key});

  @override
  State<LodgeManagementPage> createState() => _LodgeManagementPageState();
}

class _LodgeManagementPageState extends State<LodgeManagementPage>
            ...
            child: Column(
              children: [
                Header (
                  ...
                  // ),
                  brandColor: Color(0xFF2887C0),
                  titleColor: Color(0xFF2887C0),
                      ...
                      children: [
                        ElevatedButton(
                          style: ElevatedButton.styleFrom(
                            backgroundColor: Color(0xFF2887C0),
                            ...
                            elevation: 5,
                            shadowColor:Color(0xFF2887C0).withValues(alpha: 0.04),
                        ...
                        OutlinedButton(
                          style: OutlinedButton.styleFrom(
                            side: BorderSide(color: Color(0xFF2887C0), width: 2),
                            padding: const EdgeInsets.symmetric(horizontal: 32, vertical: 18),
                            shape: RoundedRectangleBorder(
                              borderRadius: BorderRadius.circular(40),
                            ),
                          ...
                          child: Text(
                            "Free Trial",
                            style: TextStyle(color:Color(0xFF2887C0)),
                          ),
                        ),
                      ],
                    ),
                ...
                Container(
                  ...
                  child: Center(
                    child: ConstrainedBox(
                      ...
                      child: Column(
                        children: [
                          _sectionTitle("Explore Our Lodge Management Live"),
                          ...
                          SizedBox(
                            width: 650,
                            child: Text(
                              "Access real-time room availability, manage bookings and staff, and generate invoices or reports from any device.",
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      _sectionTitle("Why Lodge Choose Us?"),
                      const SizedBox(height: 50),
                      _featuresGrid(),
                    ],
                  ),
                ...
                Footer(
                  title: "Ready to simplify your lodge management?",
                  buttonText: "Get Started Today",
                  onPressed: () =>
                      _launch("https://lodgemanagement.ramchintech.com"),
                  backgroundColor: Color(0xFF2887C0),
            ...
            Positioned(
              ...
              child: AnimatedOpacity(
                ...
                child: FloatingActionButton(
                  ...
                  child: const Icon(Icons.keyboard_arrow_up, size: 28,color: Color(0xFF2887C0)),
                ),
              ),
            ),
        ],
      ...
      child: Material(
        ...
        child: InkWell(
          ...
          child: Container(
            ...
            child: const Icon(Icons.arrow_back_ios_new, color: Color(0xFF2887C0), size: 20),
          ),
        ),
      ),
    );
  ...
  Widget _featuresGrid() {
    final features = [
      {
        "title": "Room Booking",
        "desc": "Check availability and book rooms instantly.",
        "icon": Icons.event_available,
      },
      {
        "title": "Manage Bookings",
        "desc": "Edit or cancel reservations and track check-ins.",
      ...
      {
        "title": "Analytics",
        "desc": "View occupancy, revenue, and booking trends.",
        "icon": Icons.bar_chart_rounded,
      },
      {
        "title": "Custom Notes",
        "desc": "Add guest instructions or service requests.",
        "icon": Icons.note_alt_rounded,
      },
      {
        "title": "Secure Access",
        "desc": "Role-based access for owners and managers.",
  ...
  Widget _downloadCard() {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color: Color(0xFF2887C0).withValues(alpha: 0.2),
            blurRadius: 30,
          ...
          Wrap(
            ...
            children: [
              ...
              StoreButton(
                ...
                label: "Website",
                onTap: () => _launch(
                    "https://lodgemanagement.ramchintech.com"
                ),
              ),
            ],
          ),
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: Colors.white,
        borderRadius: BorderRadius.circular(24),
        border: Border.all(color:Color(0xFF2887C0).withValues(alpha: 0.4)),
        boxShadow: [
          BoxShadow(
            color: Colors.black.withValues(alpha: 0.04),
            blurRadius: 25,
