...
class _FeaturesPageState extends State<FeaturesPage> {
  static const Map<String, List<Map<String, dynamic>>> roleFeatureOverview = {
    "Admin": [
      {
        "title": "Room & Lodge Booking",
        "description": "View real-time room availability, confirm bookings, and avoid double-booking from a single dashboard.",
        "icon": Icons.event_available,
      },
      {
        "title": "Booking Management",
        "description": "Modify or cancel bookings and track all active, upcoming, and canceled reservations efficiently.",
        "icon": Icons.edit_calendar,
      },
      {
        "title": "Check-in & Date Management",
        "description": "Track guest check-ins and modify booking dates when necessary to maintain accurate occupancy.",
        "icon": Icons.calendar_month,
      },
      {
        "title": "Billing & Payments",
        "description": "Generate invoices, record payments, and maintain financial records securely for all rooms and services.",
        "icon": Icons.receipt_long,
      },
      {
        "title": "Income & Expense Reports",
        "description": "Track revenue, expenses, and profit. Generate detailed monthly and yearly financial reports.",
        "icon": Icons.account_balance_wallet,
      },
      {
        "title": "Custom Instructions & Services",
        "description": "Add notes for guest services, special requests, or housekeeping instructions and share with staff.",
        "icon": Icons.note_alt_rounded,
      },
      {
        "title": "Reports & Analytics",
        "description": "Monitor room occupancy, revenue trends, cancellations, and overall lodge performance.",
        "icon": Icons.bar_chart_rounded,
      },
      {
        "title": "Secure User Access",
        "description": "Only Admin and authorized Managers can access lodge data and bookings with role-based permissions.",
        "icon": Icons.security_rounded,
      },
    ],
    "Manager": [
      {
        "title": "Manage Guest Bookings",
        "description": "View and update assigned bookings, handle check-ins, and assist with rescheduling requests.",
        "icon": Icons.event_note_rounded,
      },
      {
        "title": "Room Availability Check",
        "description": "Quickly see which rooms are available and assist guests with booking or modifying reservations.",
        "icon": Icons.calendar_today_rounded,
      },
      {
        "title": "Billing Assistance",
        "description": "Process payments, generate receipts, and help Admin maintain financial records.",
        "icon": Icons.point_of_sale_rounded,
      },
      {
        "title": "Guest Communication",
        "description": "Manage guest details, answer queries, and provide support for a smooth stay.",
        "icon": Icons.person_rounded,
      },
      {
        "title": "Booking & Cancellation History",
        "description": "Access past and current booking records, including cancellations, for reference and reporting.",
        "icon": Icons.history_rounded,
      },
      {
        "title": "Internal Communication",
        "description": "Stay connected with Admin and staff for updates, approvals, and guest service coordination.",
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        /// SUBTITLE
                        Text(
                          "A smart platform for Admins and Managers to manage lodge bookings, billing, and guest services",
                          textAlign: TextAlign.center,
                          style: TextStyle(
                            fontSize: 14,
                            height: 1.6,
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  TextButton.icon(
                                    onPressed: () async {
                                      final Uri url =
                                      Uri.parse("https://lodgepolicy.ramchintech.com");
                        ...
                        const Text(
                          "Streamlining Lodge Bookings and Room Management Efficiently",
                          textAlign: TextAlign.center,
                          style: TextStyle(
                            fontSize: 15,
